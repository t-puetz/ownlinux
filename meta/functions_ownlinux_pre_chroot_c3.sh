...
declare -f get_gcc_ver_c3
declare -f get_pkg_ver_c3
declare -f conv_meta_to_real_pkg_name_c3
declare -f get_glibc_ver_c3
declare -f get_hosts_glibc_ver_c3
declare -f extract_pkg_c3
...
if [[ $1 == "exportfcts" ]]; then
  ...
  export -f get_gcc_ver_c3
  export -f get_pkg_ver_c3
  export -f conv_meta_to_real_pkg_name_c3
  export -f get_glibc_ver_c3
  export -f get_hosts_glibc_ver_c3
  export -f get_hosts_glibc_ver_c3
  export -f extract_pkg_c3

elif [[ $1 == "unsetfcts" ]]; then

  unset -f checkBuiltPackage
  unset -f get_gcc_ver_c3
  unset -f get_pkg_ver_c3
  unset -f conv_meta_to_real_pkg_name_c3
  unset -f get_glibc_ver_c3
  unset -f get_hosts_glibc_ver_c3
  unset -f get_hosts_glibc_ver_c3
  unset -f extract_pkg_c3
fi
