...
wget http://us.download.nvidia.com/XFree86/Linux-x86_64/390.25/NVIDIA-Linux-x86_64-390.25.run -O \
  NVIDIA-Linux-x86_64-390.25.run

sudo chmod +x NVIDIA-Linux-x86_64-390.25.run
sudo bash -c 'PKG_CONFIG_PATH="${PKG_CONFIG_PATH64}" CC="gcc" CXX="g++" ./NVIDIA-Linux-x86_64-390.25.run'
